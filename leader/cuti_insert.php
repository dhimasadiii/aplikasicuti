...
$jnsc	= $_POST['jeniscuti'];
$almtc	= $_POST['alamatcuti'];
$spv	= $_POST['spv'];
...
if($durasi>$jml){
	...
	$sql 	= "INSERT INTO cuti (no_cuti, npp, tgl_pengajuan, tgl_awal, tgl_akhir, durasi, keterangan, spv, stt_cuti, alamatcuti, jeniscuti) 
				VALUES ('$id','$npp','$ajuan','$mulai','$akhir','$durasi','$ket','$spv','$stt','$almtc','$jnsc')";
