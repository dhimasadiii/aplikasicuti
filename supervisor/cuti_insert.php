...
$stt = "Menunggu Approval Depthead";
...
if($durasi>$jml){
	...
	$sql 	= "INSERT INTO cuti (no_cuti, npp, tgl_pengajuan, tgl_awal, tgl_akhir, durasi, keterangan, manager, alamatcuti, stt_cuti) 
				VALUES ('$id','$npp','$ajuan','$mulai','$akhir','$durasi','$ket','$mng','$stt','$almtc')";
