							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea name="jeniscuti" class="form-control" placeholder="Jenis Cuti" rows="3" readonly><?php echo $data['jeniscuti'];?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Alamat Cuti</label>
										<div class="col-sm-4">
											<textarea name="alamatcuti" class="form-control" placeholder="Alamat Cuti" rows="3" readonly><?php echo $data['alamatcuti'];?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Next Approved</label>
										<div class="col-sm-4">
											<select name="aksi" id="aksi" class="form-control" required>
												<option value="" selected>---- Approved/Reject ----</option>
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Depthead</label>
										<div class="col-sm-4">
