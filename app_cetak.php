			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<br>
						<br>
							<img src="libs/images/logout.png" alt="logo-dkm"  height="45" width="250"  />
						</td>
						<td class="text-center" width="60%">
						<br>
						<br>
						<h3><b>SURAT PERMOHONAN CUTI</b><h/3> <br>
						<b>PT. UNITED TRACTORS. Tbk</b> <br>
						<b>SITE BENDILI</b><br>
						<br>
						<td class="text-right" width="20%">
							<img src="libs/images/bendili.png" alt="logo-dkm" width="100" height="100"/>
						</td>
					</tr>
				</tbody>
			</table>
...
<br/>
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center"><b>FORM PENGAJUAN CUTI (APPROVED)</b></h4>
			<br />
			<br />
...
<h3>
				<tbody>
					...
					<tr>
						<td>Pilihan Cuti</td>
						<td><?php echo $result['jeniscuti'];?></td>
					</tr>
					<tr>
						<td>Alamat Cuti</td>
						<td><?php echo $result['alamatcuti'];?></td>
					</tr>
					<tr>
						<td>Status</td>
