...
$stt = "Menunggu Approval ADM Dept Head";
...
if($durasi>$jml){
	...
	$sql 	= "INSERT INTO cuti (no_cuti, npp, tgl_pengajuan, tgl_awal, tgl_akhir, durasi, keterangan, stt_cuti, alamatcuti) 
				VALUES ('$id','$npp','$ajuan','$mulai','$akhir','$durasi','$ket','$stt','$almtc')";
