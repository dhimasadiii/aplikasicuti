							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="npp" onBlur="checkNppAvailability()" class="form-control" placeholder="NRP" required>
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Tanggal Masuk Kerja</label>
										<div class="col-sm-4">
											<input type="date" name="tmk" min="0" class="form-control" placeholder="Tanggal Masuk Kerja" required>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Jumlah Cuti Site</label>
										<div class="col-sm-3">
											<input type="number" name="jml_cuti" min="0" class="form-control" placeholder="Jumlah Cuti Site" required>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Jumlah Cuti Tahunan</label>
										<div class="col-sm-3">
											<input type="number" name="jct_cuti" min="0" class="form-control" placeholder="Jumlah Cuti Tahunan" required>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Jumlah Cuti Besar</label>
										<div class="col-sm-3">
											<input type="number" name="jcb_cuti" min="0" class="form-control" placeholder="Jumlah Cuti Besar" required>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-3">
											<select name="akses" id="akses" class="form-control" required>
												...
												<option value="Leader">Pegawai</option>
												<option value="Manager">Depthead</option>
