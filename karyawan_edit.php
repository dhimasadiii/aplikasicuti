						...
						<form class="form-horizontal" action="karyawan_update.php" method="POST" enctype="multipart/form-data">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">NRP Baru (Abaikan jika tidak diubah)</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="date" name="tmk" class="form-control" placeholder="Tanggal Mulai Kerja" value="<?php echo $data['tmk'] ?>" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="number" name="jct" min="0" class="form-control" placeholder="Telepon" value="<?php echo $data['jct_cuti'] ?>"required>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3">Jumlah Cuti Besar</label>
										<div class="col-sm-3">
											<input type="number" name="jcb" min="0" class="form-control" placeholder="Telepon" value="<?php echo $data['jcb_cuti'] ?>"required>
										</div>
									</div>
									<div class="form-group">
