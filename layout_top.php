        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="libs/images/logout.png" alt="brand" height="40" width="220" class="float-left image-brand">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>Site Bendili</b></h4>
						...
						?>
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-folder fa-fw"></i>&nbsp;Absen<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Absen") {
										echo '<li><a href="biometricattendance" class="active">Absen</a></li>';
									}
									else {
										echo '<li><a href="biometricattendance">Absen</a></li>';
									}
								?>
							</ul><!-- /.nav-second-level -->
						</li>
